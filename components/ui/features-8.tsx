...
import { Shield, Users, Rocket, Lightbulb, Trophy, CodeXml, Sparkles } from 'lucide-react'
                ...
                <div className="relative z-10 grid grid-cols-6 gap-4">
                    ...
                    <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 glass-panel border-white/10 bg-white/5 backdrop-blur-xl">
                        <CardContent className="relative m-auto size-fit pt-8 pb-8">
                            <div className="relative flex h-24 w-56 items-center">
                                ...
                                <span className="mx-auto block w-fit text-5xl font-bold text-white">4</span>
                            </div>
                            <div className="mt-8 text-center">
                                <h2 className="text-2xl font-bold text-white">Hackathons</h2>
                                <p className="mt-2 text-sm text-zinc-400">Competitive coding events where creativity meets execution.</p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 glass-panel border-white/10 bg-white/5 backdrop-blur-xl">
                        <CardContent className="pt-8 pb-8">
                            ...
                            <div className="relative z-10 mt-8 space-y-2 text-center">
                                ...
                                <p className="text-sm text-zinc-400">Hands-on learning sessions covering modern tech stacks.</p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 glass-panel border-white/10 bg-white/5 backdrop-blur-xl">
                        <CardContent className="pt-8 pb-8">
                            ...
                            <div className="relative z-10 mt-8 space-y-2 text-center">
                                <h2 className="text-xl font-bold text-white transition">Projects</h2>
                                <p className="text-sm text-zinc-400">15+ real-world builds shipped to production.</p>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="grid pt-8 pb-8 sm:grid-cols-2">
                            <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-zinc-400">Experimenting with cutting-edge tech and bold ideas from AI to creative code.</p>
                                </div>
                            </div>
                        ...
                        <CardContent className="grid h-full pt-8 pb-8 sm:grid-cols-2">
                            <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                ...
                                <div className="space-y-2">
                                    <h2 className="text-2xl font-bold text-white transition">Club & Mentorship</h2>
                                    <p className="text-sm text-zinc-400">A crew of 200+ active members building together, guided by experienced teen mentors.</p>
                                </div>
                            </div>
                            <div className="before:bg-white/10 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                <div className="relative flex h-full flex-col justify-center space-y-6 py-12">
                                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-3">
                                        <span className="block h-fit rounded-full border border-white/10 bg-white/5 px-2 py-1 text-[10px] text-zinc-300 shadow-sm backdrop-blur-md">Yash S.</span>
                                        <div className="ring-background size-8 ring-4 rounded-full overflow-hidden">
                                            <Image className="size-full object-cover" src="/team/yash.jpeg" alt="Yash" width={32} height={32} />
                                        </div>
                                    </div>
                                    <div className="relative ml-[calc(50%-1.1rem)] flex items-center gap-3">
                                        ...
                                        <span className="block h-fit rounded-full border border-white/10 bg-white/5 px-2 py-1 text-[10px] text-zinc-300 shadow-sm backdrop-blur-md">Aadrika M.</span>
                                    </div>
                                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-3">
                                        <span className="block h-fit rounded-full border border-white/10 bg-white/5 px-2 py-1 text-[10px] text-zinc-300 shadow-sm backdrop-blur-md">Akshat S.</span>
                                        <div className="ring-background size-8 ring-4 rounded-full overflow-hidden">
                                            <Image className="size-full object-cover" src="/team/akshat.webp" alt="Akshat" width={32} height={32} />
                                        </div>
                                    </div>
                                </div>
                            </div>
